...
Console.WriteLine("Введите значение b2 для второй прямой: ");
double b2 = Convert.ToInt32(Console.ReadLine());
Console.WriteLine("Введите значение k2 для второй прямой: ");
...
else Console.WriteLine("Прямые параллельны, нет точек пересечения");